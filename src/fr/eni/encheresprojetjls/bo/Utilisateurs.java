...
//Classe qui crée un utilisateur
public class Utilisateurs {
	...
	List<Encheres> listEncheres;

	public List<Articles> getListArticles() {
		return listArticles;
	}

	public Utilisateurs(int noUtilisateur, String pseudo, String nom, String email, String motDePasse) {
	...
	public Utilisateurs(String pseudo, String nom, String email) {
		super();
		this.pseudo = pseudo;
		this.nom = nom;
		this.email = email;
	...
	public List<Encheres> getListEncheres() {
		return listEncheres;
	}

	public void setListEncheres(List<Encheres> listEncheres) {
	...
	public Utilisateurs() {
		...
		listEncheres = new ArrayList<Encheres>();
	}
	...
	public Utilisateurs(String pseudo, String prenom) {
		super();
		this.pseudo = pseudo;
		this.prenom = prenom;
	}
...
this.noUtilisateur=noUtilisateur;
	...
	public Utilisateurs(int noUtilisateur, String pseudo, String nom, String prenom, String email, String telephone, String rue,
			String codePostal, String ville, String motDePasse, int credit, byte administrateur, boolean activer) {
		this.noUtilisateur=noUtilisateur;
		this.pseudo = pseudo;
		this.nom = nom;
		this.prenom = prenom;
