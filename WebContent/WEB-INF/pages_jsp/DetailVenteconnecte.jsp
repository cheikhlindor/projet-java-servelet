				...
				<c:choose>
									...
									<div class="border border-info">
										...
										<div >
											<div class="card text-center">
												...
												<br />
												<p>Meilleure offre :
													${sessionScope.Encheres.Montant_enchere}</p>
												<br />
												<p>Mise à prix : ${article.miseAPrix }</p>
												<br />
												<p>Fin de l'enchère : ${article.dateFinEncheres }</p>
												<br />
												<p>Retrait : ${sessionScope.rue}
													${sessionScope.codePostal } ${sessionScope.ville }</p>
												<br />
												<p>Vendeur : ${sessionScope.pseudo }</p>
												<br />

												<form class="text-center" method="post"
													action="/ServletDetailVente">
					...
					<c:otherwise>
						<div class="alert alert-danger" role="alert">
							<p class="card-text">Pas de liste actuellement.</p>
						</div>
					</c:otherwise>
				</c:choose>
			</div>
